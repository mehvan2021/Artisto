...
class _MyAppState extends State<AboutScreenView> {
  ...
  void initState() {
    ...
    Future.microtask(() async {
      File file = File("${(await getTemporaryDirectory()).path}/song2.mp3");

      if (!file.existsSync()) {
        file.createSync(recursive: true);
        final byteData = await rootBundle.load("song1.mp3");
              ...
              children: [
                ...
                CupertinoButton(
                  ...
                  onPressed: () => notificationManager.showNotification(
                      title: "title", artist: "artist", clipArt: ""),
                ),
                CupertinoButton(
                  child: Text("updateNotification"),
                  onPressed: () => notificationManager.updateNotification(
                      showPlay: false,
                      title: "update",
                      artist: "update",
                      clipArt: ""),
